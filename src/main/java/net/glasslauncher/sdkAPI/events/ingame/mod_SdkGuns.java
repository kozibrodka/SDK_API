...
import net.glasslauncher.sdkAPI.events.init.KeyBindingListener;
import net.glasslauncher.sdkAPI.events.utils.SdkBurstShotEntry;
import net.glasslauncher.sdkAPI.events.utils.SdkItemCustomUseDelay;
import net.glasslauncher.sdkAPI.events.utils.SdkItemGun;
import net.glasslauncher.sdkAPI.events.utils.SdkTools;
import net.glasslauncher.sdkAPI.mixin.*;
...
public class mod_SdkGuns {
    ...
    public boolean OnTickInGameTick(Minecraft minecraft)
    {
        ...
        {
//            ModLoaderMp.SendKey(this, 2); //mp packet?
...
//                ((Living)entry.getKey()).movementSpeed = ((Float)((Pair)entry.getValue()).getSecond()).floatValue();
                iterator.remove();
            } else
            {
    ...
    private void handleZoom(Minecraft minecraft)
    {
        ...
        {
            if(itemstack == null || itemstack.getType() != SDK_Listener.itemGunSniper && itemstack.getType() != SDK_Listener.itemGunSg552 || minecraft.player.inventory.selectedHotbarSlot != lastZoomSlot || minecraft.options.thirdPerson || minecraft.currentScreen != null)
            {
                zoomEnabled = false;
            }
            ...
            {
                if(itemstack.getType() == SDK_Listener.itemGunSniper)
                {
                    f = 0.125F;
                } else
                {
        ...
        if(currentZoom == 0.125F && !sniperZoomedIn && itemstack != null && itemstack.getType() == SDK_Listener.itemGunSniper)
        {
            sniperZoomedIn = true;
...
//            packet230modloader1.dataInt = (new int[] {
//                    0
//            });
//            ModLoaderMp.SendPacket(this, packet230modloader1);
        }
...
//                        ModLoader.getLogger().throwing("mod_SdkGuns", "handleGuns", illegalaccessexception);
...
////                        ModLoader.getLogger().throwing("mod_SdkGuns", "handleGuns", invocationtargetexception);
////                        SdkTools.ThrowException("An impossible error has occurred!", invocationtargetexception);
//                        return;
//                    }
//                    catch(NoSuchFieldException nosuchfieldexception2)
//                    {
//                        System.out.println(nosuchfieldexception2);
////                        ModLoader.getLogger().throwing("mod_SdkGuns", "handleGuns", nosuchfieldexception2);
////                        SdkTools.ThrowException("SDK, you forgot to update your obfuscated reflection!", nosuchfieldexception2);
//                        return;
//                    }
//                    catch(NoSuchMethodException nosuchmethodexception1)
//                    {
//                        System.out.println(nosuchmethodexception1);
////                        ModLoader.getLogger().throwing("mod_SdkGuns", "handleGuns", nosuchmethodexception1);
////                        SdkTools.ThrowException("SDK, you forgot to update your obfuscated reflection!", nosuchmethodexception1);
//                        return;
//                    }
                }
            }
...
//                        ModLoader.setPrivateValue(Minecraft.class, minecraft, "leftClickCounter", Integer.valueOf(2));
    ...
    {
//        System.out.println(minecraft.interactionManager + "   "  + minecraft.interactionManager.method_1722() + "  " + minecraft.currentScreen + "  " + minecraft.options.thirdPerson + "  " +  currentZoom);
        ...
        {
            ItemInstance itemstack = minecraft.player.getHeldItem();
//            System.out.println(minecraft.player + "   " + minecraft.player.getHeldItem());
            if(itemstack != null)
            {
                ItemBase item = itemstack.getType();
//                System.out.println(itemstack.getType() + "TYPY");
...
//                    System.out.println(minecraft.options +  "  " + minecraft.actualWidth +  "  " + minecraft.actualHeight);
                    ...
                    tessellator.start();
                    if(item instanceof SdkItemGunFlamethrower)
                    {
                        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, minecraft.textureManager.getTextureId("/assets/ofensywa/stationapi/textures/item/sdk/guiAmmoOil.png"));
                    ...
                    if(item instanceof SdkItemGunLaser)
                    {
                        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, minecraft.textureManager.getTextureId("/assets/ofensywa/stationapi/textures/item/sdk/guiAmmoRedstone.png"));
...
//                        System.out.println(tessellator + "elo tesla");
                        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, minecraft.textureManager.getTextureId("/assets/ofensywa/stationapi/textures/item/sdk/guiAmmoBullet.png"));
                        for(int l1 = i1 - 1; l1 >= 0; l1--)
                        {
//                            System.out.println("rysuj1");
