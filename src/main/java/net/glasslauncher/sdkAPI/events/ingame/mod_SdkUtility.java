...
import net.glasslauncher.sdkAPI.mixin.GameRendererAccessor;
...
public class mod_SdkUtility {
    ...
    private void handleZoom(Minecraft minecraft)
    {
        ...
        if(itemstack == null || itemstack.getType() != SDK_Listener.itemTelescope || minecraft.player.inventory.selectedHotbarSlot != lastZoomSlot || minecraft.options.thirdPerson || minecraft.currentScreen != null)
        {
            currentZoomIndex = 0;
        }
